const WHATSAPP_NUMBER = import.meta.env.VITE_WHATSAPP_NUMBER || '923366132951'
...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={clsx('fixed', 'bottom-6', 'right-6', 'z-50', 'flex', 'items-center', 'justify-center', 'w-14', 'h-14', 'rounded-full', 'shadow-lg', 'bg-green-500', 'hover:bg-green-600', 'active:scale-95', 'transition-all', 'duration-200')}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 32 32"
        className={clsx('w-8', 'h-8', 'fill-white')}
      >
